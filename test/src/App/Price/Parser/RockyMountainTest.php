...
namespace rollun\test\application\App\Price\Parser;
...
class RockyMountainTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @param RockyMountain $parser
     * @return RockyMountain
     */
    public function test_parse_shouldSaveAllDataToDataStore(RockyMountain $parser)
    {
        $parser();
     ...
     */
    public function test_create_lastElementExists_shouldReturnParsedRow(RockyMountain $parser)
    {
